        ...
        <section class="hero">
          <div class="hero-grid">
            <div>
              ...
              <p class="subtitle">Prototype version: shared login, active session creation, resume, and read-only completion.</p>
            </div>
            <div class="hero-meta">
              ...
              <span class="pill"><strong>Version:</strong> Prototype</span>
            </div>
          </div>
        </section>
        ...
        <section class="card login-card">
          <div class="card-header">
            <div>
              ...
              <p class="card-subtitle">Use the shared staff credentials to reach stock take sessions. This prototype stores data locally in the browser.</p>
            </div>
  ...
  function renderSessionDetail(session) {
    ...
    return `
      <div class="session-details">
        ...
        ${isCompleted ? '<div class="readonly-note">This session is completed and read only. It can still be exported or reviewed.</div>' : '<div class="success">This session is active. Adjust counts and confirm changes.</div>'}
          ...
          <div class="mini-grid">
            ...
            ${item.serialTracked ? `
              <div class="field">
                ...
                <input id="serial-${item.id}" class="input" data-field="serial" data-session-id="${session.id}" data-item-id="${item.id}" type="text" value="${escapeHtml(item.serialNumber || '')}" ${isCompleted ? 'disabled' : ''} />
              </div>
            ` : ''}
          </div>
        </div>
